...
describe('Fixnum#coin_combinations') do
  it('gives single penny when change is 1 cent') do
    expect(1.coin_combinations([0,0,0])).to( eq("1 cent"))
  end
  it('gives pennies when change is less than 5 cents') do
    expect(3.coin_combinations([0,0,0])).to( eq("3 cents"))
  end
  ...
  it('gives 2 dimes and three pennies when change is 23 cents') do
    expect(23.coin_combinations([0,0,0])).to(eq("2 dimes 3 cents"))
  end
  ...
  it('gives 3 quarters 1 nickel and 4 pennies when change is 84 cents') do
    expect(84.coin_combinations([0,0,0])).to(eq("3 quarters 1 nickel 4 cents"))
  end
  it('gives 3 quarters 2 dimes and 4 cents when change is 99 cents') do
    expect(99.coin_combinations([0,0,0])).to(eq("3 quarters 2 dimes 4 cents"))
  end
  it('gives 2 quarters and 4 cents when change is 54') do
    expect(54.coin_combinations([0,0,0])).to(eq("2 quarters 4 cents"))
  end
  it('gives 2 quarters 2 dimes and two cents when change is 72') do
    expect(72.coin_combinations([0,0,0])).to(eq("2 quarters 2 dimes 2 cents"))
  end
  ...
  it('handles a very large change anount') do
    expect(5332.coin_combinations([0,0,0])).to(eq("213 quarters 1 nickel 2 cents"))
  end
